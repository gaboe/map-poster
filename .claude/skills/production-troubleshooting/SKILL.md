...
description: This skill should be used when debugging performance issues or errors in production or test environments. It provides a systematic investigation workflow and helper scripts for checking Sentry traces, pod health, resource usage, and Kubernetes configurations.
---
