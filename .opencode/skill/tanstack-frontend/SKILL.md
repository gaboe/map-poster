...
description: "ALWAYS LOAD THIS SKILL when: creating/modifying routes in apps/web-app/src/routes/, adding new pages, working on SSR/prefetching, using useSuspenseQuery/useQuery/useMutation, building forms, or when user mentions 'route', 'page', 'loader', 'prefetch', 'query', 'mutation', 'form'. Covers TanStack Router loaders, TRPC v11 query patterns, prefetch strategies, and type inference."
---
