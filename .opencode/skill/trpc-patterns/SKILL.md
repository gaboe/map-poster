---
name: trpc-patterns
description: "ALWAYS LOAD THIS SKILL when: creating/modifying TRPC routers in apps/web-app/src/**/trpc/, adding API endpoints, working on backend procedures, using protectedProcedure/publicProcedure, or when user mentions 'router', 'procedure', 'endpoint', 'API', 'mutation', 'query' (backend). Covers schema patterns, custom procedures, middleware, error handling."
---
