...
2. `bun outdated -r` → Empty table (no outdated packages)
...
Catalog packages are shown in State output with "catalog (...)" in the Workspace column. To check latest versions manually:
