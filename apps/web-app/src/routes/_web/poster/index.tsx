...
export const Route = createFileRoute("/_web/poster/")({
  component: PosterPage,
  head: () => ({
    meta: [
      ...seo({
        title: createPageTitle("Map Poster Generator"),
        description:
        ...
        canonical: `${env.VITE_BASE_URL}/poster`,
        image: `${env.VITE_BASE_URL}/api/og/page/poster.png`,
      }),
    ],
    links: [
      ...getCanonicalLinks(`${env.VITE_BASE_URL}/poster`),
    ],
  }),
});
...
function PosterPage() {
  ...
  // Auto-fill location when geolocation is ready
  useEffect(() => {
    if (
        ...
        <div className="container mx-auto px-4 pt-16 pb-8">
          <div className="text-center mb-12 space-y-4">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 text-sm font-medium mb-4">
              ...
              <span>AI-Powered Map Generation</span>
            </div>
