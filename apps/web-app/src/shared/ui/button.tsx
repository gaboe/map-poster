...
// Props for our Button wrapper - includes native button HTML attributes
// and makes nativeButton optional (defaults based on render prop)
type ButtonProps =
...
function Button({
  ...
  // Determine nativeButton value:
  // - If explicitly provided, use that value
  // - If render is undefined (default button), it's a native button
  // - If render is provided, default to false (can be overridden)
