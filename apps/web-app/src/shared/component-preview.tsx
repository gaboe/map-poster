      ...
      <div className="container max-w-6xl mx-auto px-4 md:px-6">
        <div className="text-center mb-8">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Beautiful, accessible components built with Base
            UI and Tailwind CSS
          </p>
        </div>
        <CoverExample />
...
function FieldExamples() {
  ...
  const handleGpuAdjustment = React.useCallback(
    (adjustment: number) => {
              ...
              <Popover>
                ...
                >
                  <PopoverHeader>
                    ...
                    <PopoverDescription>
                      Describe your task in natural
                      language. Copilot will work in the
            ...
            <AlertDialog>
              ...
              <AlertDialogContent size="sm">
                <AlertDialogHeader>
                  ...
                  <AlertDialogDescription>
                    Do you want to allow the USB accessory
