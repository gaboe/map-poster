import type { Dimensions } from "../floating-ui-react/types.js";
import type { Side } from "./useAnchorPositioning.js";
/**
...
interface UsePopupAutoResizeParameters {
   ...
   */
  onMeasureLayoutComplete?: (previousDimensions: Dimensions | null, newDimensions: Dimensions) => void;
  side: Side;
  direction: 'ltr' | 'rtl';
}
